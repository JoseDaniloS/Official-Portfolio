...
export default function ReturnToTop() {
  ...
  return (
    <button
      onClick={handleClick}
      className={`fixed cursor-pointer neon-red-button -right-5 bottom-0 text-white h-12 w-12 rounded-full shadow-lg scale-0 hover:scale-115  transition duration-400 ${isVisible
